> For the complete documentation index, see [llms.txt](https://hub.bsvblockchain.org/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://hub.bsvblockchain.org/higher-learning/bsv-academy/introduction-to-bitcoin-script/chapter-5-op_push_tx/04-signing-and-checking-the-pre-image.md).
...
<figure><img src="https://github.com/bsv-blockchain/gitbook-bsv-academy/blob/master/academy/Introduction%20to%20Bitcoin%20Script/chapter-5-op_push_tx/broken-reference" alt=""><figcaption></figcaption></figure>
...
Finally the SIGHASH flag is added (in this case, SIGHASH\_ALL). See <https://wiki.bitcoinsv.io/index.php/SIGHASH_flags> for more information on SIGHASH flags.
...
```
GET https://hub.bsvblockchain.org/higher-learning/bsv-academy/introduction-to-bitcoin-script/chapter-5-op_push_tx/04-signing-and-checking-the-pre-image.md?ask=<question>&goal=<endgoal>
```
