"""Merge classification verdicts, verify coverage, print the IN list."""
import json
...
verdicts = {}
for f in sorted(Path("data/classify_out").glob("chunk_*.json")):
...
ins.sort(key=lambda kv: archive[kv[0]]["post_date"])
