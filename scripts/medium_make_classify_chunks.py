"""Split data-medium/triage.json into chunks for parallel LLM classification."""
import json
from pathlib import Path

CHUNK_SIZE = 52

rows = json.loads(Path("data-medium/triage.json").read_text(encoding="utf-8"))
out_dir = Path("data-medium/classify_chunks")
